...
import { MapPin, Banknote, Clock, Edit, Trash2, Plus, Briefcase } from 'lucide-react';
                    ...
                    <td className="py-4 px-6">
                      <div className="flex flex-col gap-0.5 text-xs text-muted-foreground">
                        ...
                        <span className="flex items-center gap-1.5 font-medium">
                          <Banknote className="w-3.5 h-3.5 text-muted-foreground/70" /> Rp {job.payRate.toLocaleString()} / {job.payType}
                        </span>
                      </div>
                    </td>
                        ...
                        <Button
                          ...
                          onClick={() => {
                            if (confirm('Hapus lowongan ini?')) {
                              (actions as { deleteJob: (id: string) => void }).deleteJob(job.id);
                            }
                          }}
                        >
