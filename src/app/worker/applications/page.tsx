                    ...
                    applications.map((app: Application) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-6 py-5 align-top text-slate-600 whitespace-nowrap">
                          ...
                          <td className="px-6 py-5 align-top">
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-blue-50 text-blue-700 hover:bg-blue-100 transition-colors border border-blue-100"
                            >
                          ...
                          <td className="px-6 py-5 align-top text-slate-600">
                            <div className="bg-slate-50 border border-slate-100 rounded-lg p-3 text-xs leading-relaxed max-w-[280px]">
                              {app.cover_note ? (
                                <span
